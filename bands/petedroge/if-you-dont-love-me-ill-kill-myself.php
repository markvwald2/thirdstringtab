<?php $title="Pete Droge - If You Don't Love Me (I'll Kill Myself)"; include '../../include/header.php';?>	
...
function pageScroll() {
    	...
    	scrolldelay = setTimeout('pageScroll()',100); // scrolls every 100 milliseconds
			...
			<div class="content">
				...
				<div class="tab">
					<pre><p><?php include '../../tab/petedroge/pete droge - if you don\'t love me.txt';?> </p></pre>
