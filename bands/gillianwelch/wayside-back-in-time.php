<?php $title="Gillian Welch - Wayside/Back in Time"; include '../../include/header.php';?>	
...
function pageScroll() {
    	...
    	scrolldelay = setTimeout('pageScroll()',100); // scrolls every 100 milliseconds
			...
			<div class="content">
				...
				<div class="tab">
					<pre><p><?php include '../../tab/gillianwelch/Gillian Welch - Wayside-Back in Time.txt';?> </p></pre>
