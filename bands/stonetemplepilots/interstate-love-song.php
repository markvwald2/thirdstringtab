<?php $title="Stone Temple Pilots - Interstate Love Song"; include '../../include/header.php';?>	
...
function pageScroll() {
    	...
    	scrolldelay = setTimeout('pageScroll()',100); // scrolls every 100 milliseconds
			...
			<div class="content">
				...
				<div class="tab">
					<pre><p><?php include '../../tab/stonetemplepilots/stone temple pilots - interstate love song.txt';?> </p></pre>
