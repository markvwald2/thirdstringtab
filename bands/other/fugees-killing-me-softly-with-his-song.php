<?php $title="Fugees - Killing Me Softly With His Song"; include '../../include/header.php';?>	
...
function pageScroll() {
    	...
    	scrolldelay = setTimeout('pageScroll()',100); // scrolls every 100 milliseconds
			...
			<div class="content">
				...
				<div class="tab">
					<pre><p><?php include '../../tab/other/fugees - killing me softly with his song.txt';?> </p></pre>
