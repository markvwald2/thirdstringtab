<?php $title="Thin Lizzy - The Boys Are Back in Town (acoustic)"; include '../../include/header.php';?>	
...
function pageScroll() {
    	...
    	scrolldelay = setTimeout('pageScroll()',100); // scrolls every 100 milliseconds
			...
			<div class="content">
				...
				<div class="tab">
					<pre><p><?php include '../../tab/other/thin lizzy - the boys are back in town acoustic.txt';?> </p></pre>
