<?php $title="Poison Control Center - Torpedoes on Tuesday"; include '../../include/header.php';?>	
...
function pageScroll() {
    	...
    	scrolldelay = setTimeout('pageScroll()',100); // scrolls every 100 milliseconds
			...
			<div class="content">
				...
				<div class="tab">
					<pre><p><?php include '../../tab/other/poison control center - torpedoes on tuesday.txt';?> </p></pre>
