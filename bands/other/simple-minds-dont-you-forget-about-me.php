<?php $title="Simple Minds - Don't You (Forget About Me)"; include '../../include/header.php';?>	
...
function pageScroll() {
    	...
    	scrolldelay = setTimeout('pageScroll()',100); // scrolls every 100 milliseconds
			...
			<div class="content">
				...
				<div class="tab">
					<pre><p><?php include '../../tab/other/simple minds - dont you forget about me.txt';?> </p></pre>
