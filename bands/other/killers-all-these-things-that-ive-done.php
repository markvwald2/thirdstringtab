<?php $title="The Killers - All These Things That I've Done"; include '../../include/header.php';?>	
...
function pageScroll() {
    	...
    	scrolldelay = setTimeout('pageScroll()',100); // scrolls every 100 milliseconds
			...
			<div class="content">
				...
				<div class="tab">
					<pre><p><?php include '../../tab/other/Killers - All These Things That Ive Done.txt';?> </p></pre>
