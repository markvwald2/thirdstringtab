<?php $title="Steve Miller Band - Take the Money and Run"; include '../../include/header.php';?>	
...
function pageScroll() {
    	...
    	scrolldelay = setTimeout('pageScroll()',100); // scrolls every 100 milliseconds
			...
			<div class="content">
				...
				<div class="tab">
					<pre><p><?php include '../../tab/other/steve miller band - take the money and run.txt';?> </p></pre>
