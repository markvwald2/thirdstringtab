		...
		<div id="sidebar">
			...
			<div class="content">
				...
				<ul class="nav">
					...
					<li><a href="http://zerobureau.com/tab/bands/toto"><span class="ico msg"></span>Toto</a></li>
	...
	<div id="error">
		<br><br><br><br><br><br><br><br><br><br><br>Please rotate your device to<br>landscape orientation, ya dummy.<br><br>Jeez.<br><br>
	...
	<script type="text/javascript">
	try {
	var pageTracker = _gat._getTracker("UA-2139925-3");
